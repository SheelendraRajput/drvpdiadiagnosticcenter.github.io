                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current dropdown"><a href="index.php">About</a>
                                            <ul>
                                                ...
                                                <li class="dropdown"><a href="index.php">Shop</a>
                                                    <ul>
                                                        ...
                                                        <li><a href="shop-details.php">Product Single</a></li>
                                        ...
                                        <li class="dropdown"><a href="index.php">Blog</a>
                                            <ul>
                                                <li class="dropdown"><a href="index.php">Grid View</a>
                                                    <ul>
                                                        <li><a href="blog.php">2 Columns</a></li>
                                                        <li><a href="gallery.php">3 Columns</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown"><a href="index.php">List View</a>
                                                    <ul>
                                                        <li><a href="blog-3.php">Large Image</a></li>
                                                        <li><a href="blog-4.php">Small Image</a></li>
                                                    </ul>
                                                </li>
        ...
        <section class="myaccount-section">
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-12 col-sm-12 login-column">
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 register-column">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            <div class="custom-controls-stacked">
                                                <label class="custom-control material-checkbox">
                                                    <input type="checkbox" class="material-control-input">
                                                    <span class="material-control-indicator"></span>
                                                    <span class="description">I agree to all the privacy policy, terms
                                                        &amp; conditions.</span>
                                                </label>
                                            </div>
                                        </div>
