...
<!-- Google Fonts -->
<link href="../../css2?family=Saira:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
<link href="../../css2-1?family=DM+Sans:ital,wght@0,400;0,500;0,700;1,400;1,500;1,700&display=swap" rel="stylesheet">
        ...
        <div id="search-popup" class="search-popup">
            <div class="popup-inner">
                <div class="upper-box clearfix">
                    <figure class="logo-box pull-left"><a href="index.php"><img src="assets/images/logo-7.png" alt=""></a></figure>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="service-details.php"><img src="assets/images/service/service-1.jpg" alt=""></a></figure>
                                    <div class="icon-box"><i class="flaticon-biochemistry"></i></div>
                                </div>
                                <div class="lower-content">
                                    <h3><a href="service-details.php">Biochemistry Tests</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="service-details-2.php"><img src="assets/images/service/service-2.jpg" alt=""></a></figure>
                                    <div class="icon-box"><i class="flaticon-microorganism"></i></div>
                                </div>
                                <div class="lower-content">
                                    <h3><a href="service-details-2.php">Microbiology Tests</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="service-details-3.php"><img src="assets/images/service/service-3.jpg" alt=""></a></figure>
                                    <div class="icon-box"><i class="flaticon-skin"></i></div>
                                </div>
                                <div class="lower-content">
                                    <h3><a href="service-details-3.php">Histopatology Tests</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="service-details.php"><img src="assets/images/service/service-7.jpg" alt=""></a></figure>
                                    <div class="icon-box"><i class="flaticon-skin"></i></div>
                                </div>
                                <div class="lower-content">
                                    <h3><a href="service-details.php">Hormonal Assay</a></h3>
                                    <p>Mistaken idea of denouncing pleasure pain was we will give complete.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="service-details-2.php"><img src="assets/images/service/service-8.jpg" alt=""></a></figure>
                                    <div class="icon-box"><i class="flaticon-biochemistry"></i></div>
                                </div>
                                <div class="lower-content">
                                    <h3><a href="service-details-2.php">Clinical Pathology</a></h3>
                                    <p>Desires to obtain pain of itself because is pain but because occasionally.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="service-details-3.php"><img src="assets/images/service/service-9.jpg" alt=""></a></figure>
                                    <div class="icon-box"><i class="flaticon-microorganism"></i></div>
                                </div>
                                <div class="lower-content">
                                    <h3><a href="service-details-3.php">Cytopathology</a></h3>
                                    <p>These cases are perfectly simple and easy distinguish free hour.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-widget post-widget">
                                ...
                                <div class="post-inner">
                                    <div class="post">
                                        ...
                                        <h5><a href="blog-details.php">All you Need to Know about this Liver Disease</a></h5>
                                    </div>
                                    <div class="post">
                                        ...
                                        <h5><a href="blog-details.php">Ensure Your Product Quality with a Biogenix Lab</a></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
